jQuery(document).ready(function ($) {
	...
	const labels = {
		text: g10derRepeater.text,
		textarea: g10derRepeater.textarea,
		number: g10derRepeater.number,
		select: g10derRepeater.select,
		checkbox: g10derRepeater.checkbox,
		radio: g10derRepeater.radio,
		true_false: g10derRepeater.trueFalse,
		image: g10derRepeater.image,
		file: g10derRepeater.file,
		date_picker: g10derRepeater.datePicker,
		date_time_picker: g10derRepeater.dateTimePicker,
		wysiwyg: g10derRepeater.wysiwyg
	};
	...
	<div class="aer-subfield-card">
		...
		<div class="aer-subfield-header">
			...
			<div class="aer-subfield-left">
				...
				<span class="aer-subfield-title">
					${field.label || g10derRepeater.newField}
				</span>
		...
		<div class="aer-subfield-body">
			...
			<textarea
				...
				placeholder="${g10derRepeater.choicesPlaceholder}&#10;select1 : Select 1&#10;select2 : Select 2"
				data-index="${index}"
				style="
					display:${
...
$(document).on(
	...
	function(){
		...
		$(this)
			...
			.text(
				$(this).val() || g10derRepeater.newField
			);
...
$(document).on(
    'click',
    '.acf-field[data-type="g10der_repeater"] > .acf-label label',
    function(){

        $(this)
            .closest('.acf-field[data-type="g10der_repeater"]')
