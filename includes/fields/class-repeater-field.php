...
class G10DER_Repeater_Field extends acf_field {
	...
	public function initialize() {
		...
		$this->name     = 'g10der_repeater';
		$this->label    = __( 'Extended Repeater', 'g10der-repeater-fields-for-advanced-custom-fields' );
...
$field['sub_fields_json'] = wp_json_encode(
	...
	*/
	...
	acf_render_field_setting(
		...
		array(
			'label'        => __( 'Minimum Rows', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			'instructions' => __( 'Minimum number of rows required.', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			'type'         => 'number',
			'name'         => 'min',
			'min'          => 0,
		)
	...
	*/
	...
	acf_render_field_setting(
		...
		array(
			'label'        => __( 'Maximum Rows', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			'instructions' => __( 'Maximum number of rows allowed.', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			'type'         => 'number',
			'name'         => 'max',
			'min'          => 0,
		)
...
/* translators: %d: minimum number of rows required. */
		return sprintf(
			__( 'Minimum %d rows required.', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			$field['min']
		);
	}
...
/* translators: %d: maximum number of rows allowed. */
		return sprintf(
			__( 'Maximum %d rows allowed.', 'g10der-repeater-fields-for-advanced-custom-fields' ),
			$field['max']
		);
	}
